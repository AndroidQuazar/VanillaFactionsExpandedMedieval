...
namespace VFEMedieval
{
    ...
    public static class HarmonyPatches
    {
        ...
        static HarmonyPatches()
        {
            ...
            VanillaFactionsExpanded.harmonyInstance.PatchAll();

            // PawnApparelGenerator.PossibleApparelSet.CoatButNoShirt
            VanillaFactionsExpanded.harmonyInstance.Patch(typeof(PawnApparelGenerator).GetNestedType("PossibleApparelSet", BindingFlags.NonPublic | BindingFlags.Instance).GetMethod("CoatButNoShirt", BindingFlags.Public | BindingFlags.Instance),
            ...
            if (ModCompatibilityCheck.DualWield)
            {
                ...
                if (addHumanlikeOrdersPatch != null)
                    VanillaFactionsExpanded.harmonyInstance.Patch(AccessTools.Method(addHumanlikeOrdersPatch, "Postfix"),
                ...
                if (extEquipmentTracker != null)
                    VanillaFactionsExpanded.harmonyInstance.Patch(AccessTools.Method(extEquipmentTracker, "MakeRoomForOffHand"),
            ...
            if (ModCompatibilityCheck.FacialStuff)
            {
                ...
                if (humanBipedDrawer != null)
                    VanillaFactionsExpanded.harmonyInstance.Patch(AccessTools.Method(humanBipedDrawer, "DrawApparel"), transpiler: new HarmonyMethod(typeof(Patch_PawnRenderer.RenderPawnInternal), "Transpiler"));
                else
            ...
            if (ModCompatibilityCheck.RPGStyleInventory)
            {
                ...
                if (detailedRPGGearTab != null)
                {
                    ...
                    VanillaFactionsExpanded.harmonyInstance.Patch(AccessTools.Method(detailedRPGGearTab, "TryDrawOverallArmor"),
                    ...
                    VanillaFactionsExpanded.harmonyInstance.Patch(AccessTools.Method(detailedRPGGearTab, "TryDrawOverallArmor1"),
