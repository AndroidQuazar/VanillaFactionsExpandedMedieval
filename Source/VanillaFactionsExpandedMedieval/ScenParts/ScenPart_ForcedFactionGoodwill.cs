    ...
    public class ScenPart_ForcedFactionGoodwill : ScenPart
    {
        ...
        private string LabelText
        {
            get
            {
                ...
                // All factions including hidden
                    ...
                    return "VFEMedieval.AllFactionsIncludingHidden".Translate();

                // All factions (except hidden)
                return "VFEMedieval.AllFactions".Translate();
            }
        }
        ...
        public override void DoEditInterface(Listing_ScenEdit listing)
        {
            ...
            if (!alwaysHostile)
            {
                ...
                Widgets.CheckboxLabeled(startingRangeLeftPart, "VFEMedieval.StartingGoodwill".Translate().Truncate(startingRangeLeftPart.width), ref affectStartingGoodwill);
                ...
                Widgets.CheckboxLabeled(naturalRangeLeftPart, "VFEMedieval.NaturalGoodwill".Translate().Truncate(naturalRangeLeftPart.width), ref affectNaturalGoodwill);
        ...
        {
            return ScenSummaryList.SummaryWithList(scen, ForcedFactionGoodwillTag, "VFEMedieval.ScenPart_ForcedFactionRelations".Translate());
        }
        ...
        private string GoodwillModifierString(string translationKey, IntRange range)
        {
            ...
            // Otherwise add the range
                ...
                entrySection += "VFEMedieval.NumberRange".Translate(range.min, range.max);
        ...
        public override IEnumerable<string> GetSummaryListEntries(string tag)
        {
            if (tag == ForcedFactionGoodwillTag)
            {
                // Always hostile
                if (alwaysHostile)
                    yield return $"{LabelText} ({"VFEMedieval.AlwaysHostile".Translate().UncapitalizeFirst()})";
                ...
                else if (affectStartingGoodwill || affectNaturalGoodwill)
                {
                    ...
                    // Starting goodwill
                    if (affectStartingGoodwill)
                        goodwillModifierStrings.Add(GoodwillModifierString("VFEMedieval.StartingGoodwill", startingGoodwillRange));

                    // Natural goodwill
                    if (affectNaturalGoodwill)
                        goodwillModifierStrings.Add(GoodwillModifierString("VFEMedieval.NaturalGoodwill", naturalGoodwillRange));
