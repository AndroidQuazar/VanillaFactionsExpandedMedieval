...
namespace VFEMedieval
{
    ...
    public class SymbolResolver_MedievalSettlement : SymbolResolver
    {
        ...
        {
            rp.SetCustom(MedievalResolveParams.Name, new MedievalResolveParams());
            var medievalResolveParams = rp.GetCustom<MedievalResolveParams>(MedievalResolveParams.Name);
